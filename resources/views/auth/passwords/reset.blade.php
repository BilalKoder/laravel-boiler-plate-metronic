        ...
        <div class="flex-row-fluid d-flex flex-column justify-content-center position-relative overflow-hidden p-7 mx-auto">
            ...
            <div class="container">
                <div class="pb-13 pt-lg-0 pt-5">
                    ...
                    <p class="text-muted font-weight-bold font-size-h4">Change you password
                    </p>
                </div>
                @if ($errors->any())
                ...
                <div class=""> --}}
                    ...
                    <div class="login-form login-forgot">
                        <!--begin::Form-->
                        <form class="form" id="kt_login_forgot_form" method="POST" action="{{ route('password.update') }}" autocomplete="off">
                            <!--begin::Title-->
                            @csrf
