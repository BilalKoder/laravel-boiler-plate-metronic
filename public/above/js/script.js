  ...
  if ($(window).width() < 1280) {
    ...
    $("#pagepiling").pagepiling({
      ...
      onLeave: function (index, nextIndex, direction) {
        $("span.present").removeClass("present");
        $("span.hithere").removeClass("hithere");
      ...
      afterLoad: function (anchorLink, index) {
        $("." + anchorLink + ".str span:nth-child(1)").addClass("present");
        $("." + anchorLink + ".str span").on("transitionend", function () {
          if ($(this).next("span").length != 0)
            $(this).next("span").eq(0).addClass("present");
        });
        $("." + anchorLink + ".str span:last-child").on(
          "transitionend",
          function () {
            $(this).parent().addClass("hithere");
          }
        );
      },
